...
<head>
	...
	<script type="text/javascript" src="<?php echo public_url('admin');?>/js/jquery-2.2.2.js"></script>
	<script type="text/javascript" src="<?php echo public_url('');?>/ckeditors/ckeditor.js"></script>
</head>
<body>
	<div id="body">
